...
public record CamundaVariable
{
	...
	public static CamundaVariable Create(object value, string? type = null, Dictionary<string, object>? valueInfo = null)
	{
		return new CamundaVariable(value, type, valueInfo);
	}
